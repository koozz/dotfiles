...
vim.lsp.enable({ "bashls", "biome", "fish_lsp", "gh_actions_ls", "graphql", "helm_ls", "lua_ls", "marksman", "regols",
  "ruff", "sourcekit", "superhtml", "ts_ls", "vale_ls", "yamlls", "ziggy", "zls" })
...
-- {
--   -- Attach to Node inspector (Pulumi program) on port 9229
--   {
--     type = "pwa-node",
--     request = "attach",
--     name = "Attach to Pulumi (Node 9229)",
--     address = "127.0.0.1",
--     port = 9229,
--     cwd = "${workspaceFolder}/.github/pulumi",
--     -- If your TS program is transpiled, ensure source maps exist
--     sourceMaps = true,
--     -- Helps mapping TS sources while excluding node_modules
--     resolveSourceMapLocations = {
--       "${workspaceFolder}/**",
--       "!**/node_modules/**",
--     },
--     -- Optional: skip stepping into libs
--     skipFiles = {
--       "<node_internals>/**",
--       "**/node_modules/**",
--     },
--   },
--
--   -- Optional: launch a script directly with js-debug (less common for Pulumi)
--   -- This is here in case you have a custom entry script that runs Pulumi logic
--   -- under Node yourself; most workflows should use the attach config above.
--   {
--     type = "pwa-node",
--     request = "launch",
--     name = "Launch script (advanced)",
--     program = "${workspaceFolder}/.github/pulumi/index.ts",
--     cwd = "${workspaceFolder}/.github/pulumi",
--     runtimeExecutable = "node",
--     runtimeArgs = { "--require", "ts-node/register", "--inspect-brk" },
--     env = {
--       PULUMI_DEBUG_PROVIDERS = "pulumi-nodejs:9229",
--     },
--     sourceMaps = true,
--     resolveSourceMapLocations = {
--       "${workspaceFolder}/**",
